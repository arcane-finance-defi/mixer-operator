...
use super::store::{StoreError, BlockStore};
use super::ChainMmrNodeFilter;
...
mod test {
    ...
    async fn insert_dummy_block_headers(store: &mut BlockStore) -> Vec<BlockHeader> {
        ...
        store
            .interact_with_connection(move |conn| {
                ...
                (0..5).for_each(|block_num| {
                    BlockStore::insert_block_header_tx(
                        &tx,
